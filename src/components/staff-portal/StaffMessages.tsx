                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  {(selectedMsg.sender_id === user?.id || isAdmin) && (
                    <div className="flex gap-1 flex-shrink-0">
                      <Button variant="ghost" size="icon" className="h-9 w-9 md:h-7 md:w-7" onClick={openEdit} title="Edit message">
                        <Pencil className="h-3.5 w-3.5" />
                      </Button>
                      <Button variant="ghost" size="icon" className="h-9 w-9 md:h-7 md:w-7 text-destructive hover:text-destructive" onClick={() => setDeleteOpen(true)} title="Delete message">
