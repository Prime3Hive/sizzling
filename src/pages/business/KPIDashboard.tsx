...
import { ArrowLeft, Users, CalendarCheck, AlertTriangle, Clock, TrendingUp, Award, Building2, UserCheck } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Monitor workforce metrics, leave, complaints and department health</p>
        </div>
      </div>
